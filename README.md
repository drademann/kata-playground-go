...
* Prime Factors (thanks to _Uncle Bob_ 
  [Robert C. Martin's Prime Factor Kata](http://butunclebob.com/ArticleS.UncleBob.ThePrimeFactorsKata))
* String Calculator (thanks to [Roy Osherove](http://osherove.com/tdd-kata-1/))

A description with requirements for each Kata.
